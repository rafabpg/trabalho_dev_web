          ...
          <table className="min-w-full bg-white">
            ...
            <tbody>
              {data!.data.content.map((series) => (
                <tr key={series.id}>
                  <td className="py-2 px-4 border-b text-center">{series.id}</td>
                  <td className="py-2 px-4 border-b text-center">
                    <img src={series.imageUrl} alt={series.title} className="w-16 h-16 object-cover mx-auto" />
                  </td>
                  <td className="py-2 px-4 border-b text-center">{series.title}</td>
                  <td className="py-2 px-4 border-b text-center">{series.description}</td>
                  <td className="py-2 px-4 border-b text-center">{series.year}</td>
                  <td className="py-2 px-4 border-b text-center">
            ...
            <tfoot>
              <tr>
                ...
                <td colSpan={2} className="py-2 px-4 border-b text-center font-bold">
                  {data!.data.content.reduce((total, series) => total + series.price, 0).toLocaleString("pt-BR", {
                    style: "currency",
                    currency: "BRL",
                  })}
                </td>
